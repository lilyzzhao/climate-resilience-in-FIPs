...
library(grid)
library(here)
# Assuming df_tier1 and df_tier2 are your initial dataframes
t1_path <- here("data", "processed_data", "tier1_data.csv")
...
a <- read_csv("data/attribute_meta.csv")



combined_max_scores<-read_csv("data/processed_data/Figure_2_data.csv")
...
combined_max_scores <- left_join(combined_max_scores, a, by = "attribute")
...
ggsave("main_figures/Figure_2.png", width = 6, height = 5, dpi = 600, device = "png")
